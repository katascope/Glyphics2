...
namespace WebServer
{
    class WebResponder
    {
        ...
        public static bool GetResponse(HttpListenerContext context)
        {
            ...
            else if (url.Equals("/Execute"))
            {
                ...
                Code code = RasterApi.CreateCode(worldPart);
                Grid grid = RasterApi.CodeToGrid(code);
                SerializedRects srects = GraphicsApi.RectsToSerializedRects(GraphicsApi.GridToRects(grid));
            ...
            else if (url.Equals("/srects2html"))
            {
                ...
                SerializedRects srects = GraphicsApi.CreateSerializedRects(serializedRectsString);
                RectList rects = GraphicsApi.SerializedRectsToRects(srects);
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            Codes = GraphicsApi.GlyToCodes(mediaPath + "default.gly");
