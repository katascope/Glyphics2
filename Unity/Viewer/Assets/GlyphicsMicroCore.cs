...
public class Glyphics
{
    ...
    public static void DecodeToGrid(string serial)
    {
                ...
                case CharRects3D://Reading emergents
                    {
                        ...
                        //cube.transform.TransformVector(0.001f, 0.001f, 0.001f);
                        cube.GetComponent<Renderer>().material.color = new Color((float)R / (float)64, G / (float)64, B / (float)64);// Color.cyan;
                        cube.transform.position = new Vector3(mx, my, mz);
                        cube.transform.localScale = new Vector3(sx, sy, sz);
                        gameObjects[count++] = cube;
                        //        GetComponent<Renderer>().material.color = Color.cyan;
                        //cube.AddComponent<Renderer>().material.color = Color.cyan;
                        //cube.ma
                        //cube.transform.TransformVector(50, 10, 1);
                        cube = null;
